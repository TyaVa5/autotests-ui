...
class CreateCourseFormcomponent(BaseComponent):
    def __init__(self, page):
        ...
        self.create_course_estimated_time_input = Input(page, 'create-course-form-estimated-time-input', 'Create Course Time')
    ...
    @allure.step('Check visible create course form component')
    def check_visible(
            self,
            title: str,
            estimated_time: str,
    ...
    @allure.step('Fill create course from component')
    def fill(
            self,
            title: str,
            estimated_time: str,
